...
public class LoginStepDef {
    ...
    public void LoginUserSucces() {
        File json = new File(Constant.JSON_REQUEST + "/PostLogin.json");
    ...
    public void ValidateLoginUser(){
        File json = new File(Constant.JSON_SCHEMA + "/LoginSuccessSchema.json");
        SerenityRest.then()
                .assertThat()
    ...
    public void postLoginInvalidUserWithValidJson() {
        File json = new File(Constant.JSON_REQUEST + "/PostInvalidLogin.json");
    ...
    public void ValidateInvalidLoginUser(){
        File json = new File(Constant.JSON_SCHEMA + "/LoginUnsuccessSchema.json");
